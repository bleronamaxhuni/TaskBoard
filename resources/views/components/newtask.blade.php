...
<div class="flex w-full justify-end ml-[-35px] lg:ml-0">
    <div class="overflow-y-auto top-0 w-8/12 lg:w-full p-8 rounded-lg hidden shadow-lg shadow-gray-300 bg-white mt-4" id="modal">
        <form action="/tasks/create" method="POST">
            ...
            <select x-cloak id="select" class="w-full p-2 mt-2 mb-3  pl-4 pr-10 py-3 leading-none rounded-lg shadow-sm focus:outline-none text-gray-600 font-medium focus:ring focus:ring-blue-50 bg-gray-200">
                @foreach ($tags as $tag )
